...
from .views import ResolucionCrearPaginaView, ResolucionUniversitariaGenerarPDFView, ResolucionUniversitariaGenerarWordView
...
urlpatterns = [
    ...
    path('generar-word/', ResolucionUniversitariaGenerarWordView.as_view(), name='ru-generar-word'),
]